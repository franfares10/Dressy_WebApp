...
face_classifier = cv2.CascadeClassifier(
    r'E:\\Escritorio\\Dressy_AI_Service\\haarcascade_frontalface_default.xml')
classifier = tf.keras.models.load_model(r'E:\\Escritorio\\Dressy_AI_Service\\classifierCorregido.h5') #El que entrenamos nosotros en jupyter
